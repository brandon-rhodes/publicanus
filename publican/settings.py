# Django settings for publican project.
...
SECRET_KEY = '^$iq8#7t9vv06xvkw87uar^2(4^z1)-rt7oi(2vfdl6nt(rghm'
...
MIDDLEWARE_CLASSES = (
    ...
    'publican.engine.middleware.CompanyMiddleware',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'publican.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'publican.wsgi.application'
